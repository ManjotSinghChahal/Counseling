...
public class Profile extends Fragment {
    ...
    String user_id, name,last_name, email, phone_no, address, dob, user_image,country_code;
                ...
                public void onGetProfileStatus(String jsonObject) {
                    try {
                        ...
                        //    address = jsonObject2.getString("address");
                            ...
                            Global.user_name = name+" "+last_name;
                            ...
                            try {
                              ...
                              //  txtAddressProfileVal.setText(address);
                                ...
                                ((MainActivity) getActivity()).txtviewUsernameNav.setText(Global.user_name);
