...
import com.tenserflow.therapist.fragment.WebviewBack;
 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra("statusEntery")) {
            ...
            if (intent.getStringExtra("statusEntery").equalsIgnoreCase("Register"))
    ...
    public void onBackPressed() {
      //  super.onBackPressed();
        ...
        {
            Global.changeFragment(this,new Home(),"no");
        ...
        {
            Global.changeFragment(this,new Profile(),"no");
        ...
        else if (f instanceof ContactUs)
        {
            Global.changeFragment(this,new Home(),"no");
        ...
        else if (f instanceof BookingHistory)
        {
            Global.changeFragment(this,new Home(),"no");
        ...
        else if (f instanceof SessionRecord) {
        ...
        else if (f instanceof WebviewBack)
        {
      ...
      /*  else if (f instanceof Payment)
        {
         //    Global.changeFragment(this,new BookingDetail(),"no");

            fragmentManager.popBackStackImmediate();


            *//*userNameMainOptions.setText("");
            editbtnMain.setVisibility(View.GONE);
            relBackMainactivity.setVisibility(View.GONE);
            relMenuMainactivity.setVisibility(View.VISIBLE);*//*
        }*/
        ...
        {
            if (fm.getBackStackEntryCount()==0  || f instanceof Home)
            {
            ...
            public void onGetProfileStatus(String jsonObject) {
                try {
                    ...
                    if (status.equalsIgnoreCase("1")) {
                        ...
                        Global.user_name =f_name +" "+l_name;
