...
public class Date_time_Adapter extends RecyclerView.Adapter<Date_time_Adapter.ViewHolder> {
    ...
    onDateTimeCallBack callBack;



    public Date_time_Adapter(Context bookingDetail, ArrayList<HashMap<String, String>> hashMapDateTime,onDateTimeCallBack callBack_) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       // holder.txtviewSETimeAdpt.setText(hashMapDateTime.get(position).get("s_time")+" - "+hashMapDateTime.get(position).get("e_time"));
        holder.txtviewSETimeAdpt.setText(hashMapDateTime.get(position).get("slot_time"));
