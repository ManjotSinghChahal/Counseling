...
/**
 * Created by Manjot on 12/18/2018.
 */
            ...
            if (intent.hasExtra("way"))
            {
                ...
                if (way.equalsIgnoreCase("TermsOfUse"))
                {
                   ...
                   // webView.loadUrl("http://therapy.gangtask.com/terms.php");
                    webView.loadData(Global.TERMS_CONDITIONS, "text/html", "UTF-8");

                }
                else if (way.equalsIgnoreCase("PrivacyPolicy"))
                {
                  ...
                  //  webView.loadUrl("http://therapy.gangtask.com/policy.php");
                    webView.loadData(Global.PRIVACY_POLICY, "text/html", "UTF-8");
                }
