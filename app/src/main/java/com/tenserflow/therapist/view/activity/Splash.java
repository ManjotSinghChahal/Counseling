    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Thread timer = new Thread() {
            public void run() {
                ...
                String rememberME = HelperPreferences.get(Splash.this).getString("rememberME");
                String logout_status = HelperPreferences.get(Splash.this).getString("logout_status");

                String username = HelperPreferences.get(Splash.this).getString("username");
                String password = HelperPreferences.get(Splash.this).getString("password");



                //------------first time after install------------------------------------
                if (rememberME == null || rememberME.equalsIgnoreCase(""))
                {
                ...
                //---------already logged in----------------------------------------------
                    ...
                    if (logout_status.equalsIgnoreCase("logout")) {
                        if (rememberME.equalsIgnoreCase("checked")) {
