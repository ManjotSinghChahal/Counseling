...
public class EditProfile_Api {
    ...
    Context context;
    String phone_no, name,nameLast,address,email;
    ...
    public void edit_profile(Context registerScreen, final String name,final String nameLast, final String phone_no, final String address, final String email, final RelativeLayout relEditProfile, String img_path,String ccpVal,byte[] byteArray ) {
      ...
      try {
        ...
        RequestBody nameLastRB  = RequestBody.create(MediaType.parse("text/plain"), nameLast);
        ...
        {
            call = service.editProfile( Global.token,nameRB,nameLastRB , emailRB,phone_noRB ,addressRB,dobRB,"",ccpValRB,flagRB,localRB);
        }
        else
        {
           call = service.editProfile1( Global.token,nameRB,nameLastRB , emailRB,phone_noRB ,addressRB,dobRB,imagefile_new,ccpValRB,flagRB,localRB);
