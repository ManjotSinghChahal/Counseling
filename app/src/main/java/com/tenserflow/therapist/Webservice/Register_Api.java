...
public class Register_Api {
    ...
    Context context;
    String username,usernameLast, password, email_reg, phone_number, address, dob,ccpVal;
    RelativeLayout relTopSignup;




    public void register(Context registerScreen, final String username,final String usernameLast, final String email_reg, final String password, final String phone_number, final String address, final String dob,final RelativeLayout relTopSignup,String ccpVal) {
        ...
        Call<JsonObject> call = service.register(context.getString(R.string.auth_value),username,usernameLast, email_reg, password, phone_number, address, dob,ccpVal,"");
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("1")) {
                        ...
                        HelperPreferences.get(context).saveString("username",email_reg);
                        HelperPreferences.get(context).saveString("password",password);
                        HelperPreferences.get(context).saveString("logout_status","login"); // to check whether login or logout
